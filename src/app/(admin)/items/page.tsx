    ...
    return (
            <div className="max-w-[calc(73vw)] mx-auto">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <Link
                        href="/items/add" // Global Add Button (Optional if you want per category only)
                                        ...
                                        <div className="flex gap-4 min-w-min">
                                            {group.items.map((item) => (
                                                <div
                                                    ...
                                                    className="group min-w-[280px] w-[280px] bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl overflow-hidden cursor-pointer hover:shadow-md transition-all relative"
                                                >
                                                    {/* Image */}
                                            ...
                                            {/* Empty State Card for 'Add New' visual cue inside list */}
                                            <Link
                                                href={`/items/add?categoryId=${group.info.id}`}
