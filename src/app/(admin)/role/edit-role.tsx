...
const EditRole = ({ onAction, Role }: { onAction?: () => void; Role: iRole }) => {
    ...
    async function saveRole(e: any) {
        ...
        setSavingRole(true);
        try {
            const res = await permServ.updateRole(RoleForm); // Assuming updateRole exists and takes RoleForm (with ID)
            if (res.success) {
                ...
                <div className="flex flex-col h-[85vh] bg-white dark:bg-gray-800">
                    ...
                    <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
                        <div className="p-6 overflow-y-auto">
                            <form id="edit-role-form" onSubmit={saveRole} className="space-y-6">
                                <div>
                                    <Input
                                        required
                                        name="name"
