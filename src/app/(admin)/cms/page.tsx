                                                                            ...
                                                                            field === 'thumbnailUrl' ? 'Video Thumbnail' :
                                                                                field === 'backgroundColor' ? 'Section Background Color' :
                                                                                    field === 'backgroundImageUrl' ? 'Section Background Image' :
                                                                                        field === 'bgImage' || field === 'imageUrl' ? 'Banner Image' :
                                                                        ...
                                                                        <div className="space-y-1.5">
                                                                            <div className="flex items-center justify-between">
                                                                                ...
                                                                                <span className="text-[10px] font-bold text-brand-500 bg-brand-50 dark:bg-brand-500/10 px-2 py-0.5 rounded-md border border-brand-100 dark:border-brand-900/30">
                                                                                    {isThemeLogo ? (fieldDescriptions[field]?.size || 'Recommended') : (field === 'logoUrl' ? '50-400px' : field.toLowerCase().includes('favicon') ? 'Max 50px' : field === 'rightImage' ? '800×800 px' : sectionKey === 'banner' ? (activeTab === 'home' ? '1920×1080 px' : '1920×800 px') : field === 'bgImage' || field === 'imageUrl' ? '1920×800 px' : '400×200 px')}
                                                                                </span>
                                                                            </div>
                                                                            <ImageUpload
                                                                                label=""
