                        ...
                        {loading ? (
                            ...
                            ingredients.map((ing: any, index: number) => (
                                <>
                                    ...
                                    <tr
                                        key={ing.id}
                                        className={`hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors ${openId === ing.id ? "bg-gray-50 dark:bg-gray-700/50" : ""
                                            }`}
                                    >
                                        ...
                                        <td className="px-4 py-3">
                                            <button
                                                onClick={() => setOpenId(openId === ing.id ? null : ing.id)}
                                                className={`p-2 rounded transition-colors ${openId === ing.id
                                                ...
                                                <div className="grid md:grid-cols-2 gap-8 items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="space-y-2 text-gray-600 dark:text-gray-300">
                                                            <p><span className="font-medium text-gray-900 dark:text-gray-200">Name:</span> {ing.name}</p>
                                                            <p><span className="font-medium text-gray-900 dark:text-gray-200">Measuring Unit:</span> {ing.unit}</p>
                                                            <p className="text-xs font-mono text-gray-400 mt-2">ID: {ing.id}</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex flex-col justify-between h-full">
                                                        <div className="text-xs text-gray-500 dark:text-gray-400 space-y-1 mb-4">
                                                            <p>Created At: {new Date(ing.createdAt).toLocaleString()}</p>
                                                            <p>Last Updated: {new Date(ing.updatedAt).toLocaleString()}</p>
                                                        </div>
                                                        ...
                                                        <div className="flex gap-3 pt-4 border-t dark:border-gray-600">
                                                            <button
                                                                ...
                                                                className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-white bg-blue-600 rounded hover:bg-blue-700 transition-colors shadow-sm"
                                                            >
                                                                <Edit size={14} /> Edit Ingredient
                                                            </button>
                                                            <button
                                                                onClick={() => setDeleteId(ing.id)}
                                                                className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-red-600 bg-red-50 border border-red-200 rounded hover:bg-red-100 dark:bg-red-900/20 dark:border-red-800 dark:text-red-300 dark:hover:bg-red-900/40 transition-colors"
                                                            >
