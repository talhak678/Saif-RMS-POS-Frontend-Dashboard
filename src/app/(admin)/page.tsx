    ...
    <div className="space-y-5 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 border border-gray-100 dark:border-gray-700 shadow-sm">
          <SectionHeader icon={<CreditCard size={16} />} title="Subscription Revenue" sub={`$. ${Number(data.totalSubscriptionRevenue).toLocaleString()} total`} />
            ...
            <div className="space-y-3 max-h-64 overflow-y-auto pr-1">
              {data.subscriptionRevenue.map((s, i) => (
                <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-bold text-gray-900 dark:text-white">$ {Number(s.price).toLocaleString()}</p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 border border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <ReactApexChart
          options={trendChart}
          series={[{ name: chartTab === "revenue" ? "Revenue ($)" : "Orders", data: data.monthlySalesTrend.map(m => chartTab === "revenue" ? m.revenue : m.orders) }]}
          type="bar" height={210} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-7 bg-white dark:bg-gray-800 rounded-2xl p-5 border border-gray-100 dark:border-gray-700 shadow-sm">
          ...
          <ReactApexChart
            ...
            series={[{ name: chartTab === "revenue" ? "Revenue ($)" : "Orders", data: data.monthlySales.map(m => chartTab === "revenue" ? m.revenue : m.orders) }]}
            type="bar" height={210} />
        </div>
