      ...
      >
        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
          {notifications.length === 0 ? (
            <li className="p-10 text-center text-gray-500 dark:text-gray-400">
                ...
                >
                  <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                    <div className="w-10 h-10 rounded-full bg-brand-500 flex items-center justify-center text-white text-xs font-bold">
                      {notification.message.includes("upgrade") ? "UP" : "REQ"}
                    </div>
                    {!notification.isRead && (
                  ...
                  <span className="block flex-1">
                    <span className={`mb-1.5 block text-theme-sm ${!notification.isRead ? "font-semibold text-gray-900 dark:text-white" : "text-gray-500 dark:text-gray-400"}`}>
