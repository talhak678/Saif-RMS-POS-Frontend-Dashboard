            ...
            {!isSuperAdmin && (
              <>
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                  ...
                  {/* // if the url is https://rms-pos-super-admin.vercel.app/ then tha social btns not comes */}
                ...
                <div className="relative py-3 sm:py-5">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="p-2 text-gray-400 bg-white dark:bg-gray-900 sm:px-5 sm:py-2 rounded-full">
                      Or
                    </span>
                  </div>
                </div>
