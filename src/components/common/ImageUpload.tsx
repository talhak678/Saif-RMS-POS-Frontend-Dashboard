...
import { Upload, X, Image as ImageIcon, CheckCircle2, AlertCircle, Video } from "lucide-react";
    ...
    return (
        <div className="space-y-2 w-full">
            ...
            <div className="relative w-full">
                ...
                <input type="file" ref={fileInputRef} onChange={handleUpload} className="hidden" accept={isVideo ? "video/*" : "image/*"} />
            </div>
        </div>
    );
};
